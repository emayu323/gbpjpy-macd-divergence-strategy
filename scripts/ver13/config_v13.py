"""
System Ver13 - MACD Divergence Strategy 設定ファイル
...
# Ver13: 50EMA単独判定（価格 > 50EMA で上昇トレンド）
...
# 出力設定
# ==========================================
RESULTS_DIR = "./results_v13"
REPORT_FILE = f"{RESULTS_DIR}/backtest_report_v13.txt"
TRADES_CSV = f"{RESULTS_DIR}/trades_v13.csv"
DIVERGENCES_CSV = f"{RESULTS_DIR}/divergences_v13.csv"
