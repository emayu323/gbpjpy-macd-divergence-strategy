"""
System Ver12 - MACD Divergence Strategy 設定ファイル
...
# Ver12: 50EMA単独判定（価格 > 50EMA で上昇トレンド）
...
REPORT_FILE = f"{RESULTS_DIR}/backtest_report_v12.txt"
TRADES_CSV = f"{RESULTS_DIR}/trades_v12.csv"
DIVERGENCES_CSV = f"{RESULTS_DIR}/divergences_v12.csv"
