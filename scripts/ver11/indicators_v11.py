"""
System Ver11 - インジケーター計算モジュール
RCI, EMA, MACD, ZigZag, ダイバージェンス検出
Ver11: 1時間足パーフェクトオーダー（20/30/40 EMA）追加
"""
