"""
System Ver17 - バックテストエンジン
Ver17: 5分足RCI±70反転 + 5M PO + 1H PO + 暫定ピボットDiv（1H RCIなし）
"""
...
class BacktestEngineV17:
    ...
    def run_backtest(self) -> pd.DataFrame:
        print("バックテスト開始...")
        print(f"Ver17: 1H PO={config.USE_1H_PO}, 1H RCI={config.USE_1H_RCI}")
