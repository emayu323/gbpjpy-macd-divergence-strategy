"""
System Ver17 - MACD Divergence Strategy 設定ファイル
Ver17: 5分足RCI±70反転 + 5M PO + 1H PO + 暫定ピボットDiv
       ※1H RCI条件なし（Ver16との比較用）
"""
...
# 出力設定
RESULTS_DIR = "./scripts/results_v17"
REPORT_FILE = f"{RESULTS_DIR}/backtest_report_v17.txt"
TRADES_CSV = f"{RESULTS_DIR}/trades_v17.csv"
DIVERGENCES_CSV = f"{RESULTS_DIR}/divergences_v17.csv"
