"""
System Ver9 - MACD Divergence Strategy 設定ファイル
...
# Ver9: 50EMA単独判定（価格 > 50EMA で上昇トレンド）
EMA_4H = 50   # 4時間足トレンド判定に使用

# EMA (1時間足パーフェクトオーダー用) - Ver9で追加
...
REPORT_FILE = f"{RESULTS_DIR}/backtest_report_v9.txt"
TRADES_CSV = f"{RESULTS_DIR}/trades_v9.csv"
DIVERGENCES_CSV = f"{RESULTS_DIR}/divergences_v9.csv"
