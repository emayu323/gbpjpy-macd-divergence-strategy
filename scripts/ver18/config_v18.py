"""
System Ver18 - MACD Divergence Strategy 設定ファイル
Ver18: 5分足RCI±70反転 + 5M PO + 1H RCI±60 + 暫定ピボットDiv
       ※1H PO条件なし（Ver16との比較用）
"""
...
# 出力設定
RESULTS_DIR = "./scripts/results_v18"
REPORT_FILE = f"{RESULTS_DIR}/backtest_report_v18.txt"
TRADES_CSV = f"{RESULTS_DIR}/trades_v18.csv"
DIVERGENCES_CSV = f"{RESULTS_DIR}/divergences_v18.csv"
